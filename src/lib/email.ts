// ارسال ایمیل‌های احراز هویت (تایید ایمیل و بازیابی رمز عبور).
...
export async function sendVerificationEmail({
    ...
    body: JSON.stringify({
      ...
      html: `
        <div dir="rtl" style="font-family: sans-serif; line-height: 1.8;">
          <p>برای تایید ایمیل و فعال‌سازی حساب‌تان روی لینک زیر کلیک کنید.</p>
          <p><a href="${url}">تایید ایمیل</a></p>
  ...
  if (!res.ok) {
    ...
    console.error("ارسال ایمیل تایید ناموفق بود:", res.status, body);
